...
public class GuiDemo extends JFrame{
	...
	public GuiDemo() {
		...
		menuBar.add(iconSupport.createMenu()); // 1) Made a menu
    ...
    private class ChooseBackgroundAction extends AbstractAction {
    	...
    	ChooseBackgroundAction(String text) {
    		...
    		if (text.equals("Color...")) 
    		{
    			...
    			putValue(Action.SHORT_DESCRIPTION, "Select the colors that you want!");
    		
    		}
    			 
    		else if (text.equals("Custom...")) {
    			putValue(Action.SMALL_ICON, Util.iconFromResource("resources/action_icons/fileopen.png")); //Need to add image here
    			putValue(Action.SHORT_DESCRIPTION, "If you want to customized the background");
    		}
