...
public class TextMenu extends JMenu {
	...
	public TextMenu(DrawPanel owner) {
		...
		add(italic);
		add(bold);
		add(justifyContent()); //Added a method that returns a JMenu
		addSeparator();
	...
	private JMenu justifyContent() {
		
		JMenu justifyMenu = new JMenu("Justify");
		ButtonGroup justifyButtonGroup = new ButtonGroup();
		
		//Left justification
		JRadioButtonMenuItem leftJustifyItem = new JRadioButtonMenuItem("Left");
		leftJustifyItem.setSelected(true);
		justifyButtonGroup.add(leftJustifyItem);
		justifyMenu.add(leftJustifyItem);
		
		//Creating a lambda function to justify the content to the left
		leftJustifyItem.addActionListener(e -> {
		...
		//Right Justification
		JRadioButtonMenuItem rightJustifyItem = new JRadioButtonMenuItem("Right");
		justifyButtonGroup.add(rightJustifyItem);
		justifyMenu.add(rightJustifyItem);
		
		//Creating a lambda function to justify the content to the right
		rightJustifyItem.addActionListener(e -> {
